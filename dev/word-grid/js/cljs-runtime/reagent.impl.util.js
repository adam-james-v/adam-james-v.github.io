...
var vec__36153 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
var seq__36154 = cljs.core.seq(vec__36153);
var first__36155 = cljs.core.first(seq__36154);
var seq__36154__$1 = cljs.core.next(seq__36154);
var start = first__36155;
var parts = seq__36154__$1;
...
(reagent.impl.util.PartialFn.prototype.call = (function (unused__9507__auto__){
var self__ = this;
var self__ = this;
var G__36158 = (arguments.length - (1));
switch (G__36158) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args36157){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args36157)));
}));
...
var _STAR_always_update_STAR__orig_val__36159 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__36160 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__36160);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__36159);
}} else {
