...
return cljs.core.array_QMARK_(a);
});
/**
 * Return true if `f` is NaN (Not-a-Number)
 */
same.platform.nan_QMARK_ = (function same$platform$nan_QMARK_(f){
return isNaN(f);
});
/**
...
if(cljs.core.truth_(same.platform.nan_QMARK_(f))){
return f;
} else {
return (0);
...
return cljs.core.infinite_QMARK_(f);
});
/**
...
var epsilon = Math.pow(2.0,(-52));
var max_value = ((2.0 - epsilon) * Math.pow(2.0,(1023)));
var max_ulp = Math.pow(2.0,(971));
if(cljs.core.truth_(same.platform.nan_QMARK_(f__$1))){
return f__$1;
} else {
if(same.platform.is_infinite_QMARK_(f__$1)){
return f__$1;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(max_value,f__$1)){
return max_ulp;
} else {
...
var ___$2 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(lo,(4294967295)))?dv.setUint32((0),(hi + (1))):null);
...
return same.platform.ulp_STAR_(f);
});
/**
...
//# sourceMappingURL=same.platform.js.map
