...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26315 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26315(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26318 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26318(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26319 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26319(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26320 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26320(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26321 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26321(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26322 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26322(reader);
}
});
...
var G__26349 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26350 = s.append(c);
c = G__26349;
s = G__26350;
continue;
}
